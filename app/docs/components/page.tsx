...
import { getRegistry, type ComponentManifest } from '@/lib/registry';
...
export default function ComponentsIndexPage() {
  ...
  const byCategory = registry.components.reduce(
    (acc: Record<string, ComponentManifest[]>, component: ComponentManifest) => {
  ...
  return (
    <div className="max-w-4xl">
      ...
      {(Object.entries(byCategory) as [string, ComponentManifest[]][]).map(([category, components]) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {components.map((component) => (
              ...
              >
                ...
                <p className="text-[13px] leading-4 text-white/48 tracking-[0.12px]">{component.description}</p>
