...
const tocItems: TOCItem[] = [
	...
	{ id: "aria", title: "ARIA Patterns" },
	{ id: "forms", title: "Form Accessibility" },
			...
			<div className="max-w-4xl pb-16">
				...
				<section className="mb-16">
					...
					<p className="text-[15px] leading-6 text-white/72 mb-6 tracking-[0.12px]">
						Import these utilities from the main package to enhance
					...
					<div className="mb-8">
						...
						<p className="text-[13px] leading-5 text-white/64 mb-4 tracking-[0.12px]">
							...
							animations for users who have enabled the &quot;Reduce
							motion&quot; setting in their operating system.
						</p>
						<CodeBlock
							language="tsx"
					...
					<div className="space-y-4">
						<div className="bg-white/4 border border-white/8 rounded-lg p-4">
							...
							<ul className="text-[13px] leading-5 text-white/64 space-y-1">
								<li>
									<code className="text-green-400">Tab</code> - Move focus
									between focusable elements
								</li>
								<li>
									<code className="text-green-400">Shift + Tab</code> - Move
									focus backwards
								</li>
								<li>
						...
						<div className="bg-white/4 border border-white/8 rounded-lg p-4">
							...
							<ul className="text-[13px] leading-5 text-white/64 space-y-1">
								...
								<li>
									<code className="text-green-400">End</code> - Move to last
									item
								</li>
								<li>
						...
						<div className="bg-white/4 border border-white/8 rounded-lg p-4">
							...
							<ul className="text-[13px] leading-5 text-white/64 space-y-1">
								...
								<li>
									<code className="text-green-400">Page Down</code> - Decrease
									by larger step
								</li>
								<li>
				...
				<section>
					...
					<ul className="space-y-3 text-[13px] leading-5 text-white/64">
						...
						<li className="flex gap-3">
							...
							<span>
								<strong className="text-white/88">axe DevTools</strong> -
						...
						<li className="flex gap-3">
							...
							<span>
								<strong className="text-white/88">Lighthouse</strong> - Built
