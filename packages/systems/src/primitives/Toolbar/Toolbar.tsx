...
const Button = forwardRef<HTMLButtonElement, ToolbarButtonProps>((props, ref) => {
...
const Separator = forwardRef<HTMLDivElement, ToolbarSeparatorProps>((props, ref) => {
...
const ToggleGroup = forwardRef<HTMLDivElement, ToolbarToggleGroupProps>((props, ref) => {
  const { type = 'single', children, className, ...rest } = props;

  return (
    <div ref={ref} role="group" data-type={type} className={className} {...rest}>
      {children}
    </div>
  );
});
...
const ToggleItem = forwardRef<HTMLButtonElement, ToolbarToggleItemProps>((props, ref) => {
  const { value, children, className, ...rest } = props;

  return (
    <button ref={ref} type="button" data-value={value} className={className} {...rest}>
      {children}
    </button>
  );
});
