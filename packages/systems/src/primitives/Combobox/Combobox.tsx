...
const Input = forwardRef<HTMLInputElement, ComboboxInputProps>((props, ref) => {
  ...
  return (
    <input
      ...
      aria-activedescendant={context.activeIndex >= 0 ? `${context.listboxId}-${context.activeIndex}` : undefined}
...
const Trigger = forwardRef<HTMLButtonElement, ComboboxTriggerProps>((props, ref) => {
...
const Content = forwardRef<HTMLDivElement, ComboboxContentProps>((props, ref) => {
