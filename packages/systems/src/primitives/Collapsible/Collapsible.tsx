...
const Root = forwardRef<HTMLDivElement, CollapsibleRootProps>((props, ref) => {
  ...
  return (
    <CollapsibleContext.Provider value={{ open, onOpenChange: handleOpenChange, disabled, contentId }}>
      <div
        ref={ref}
...
const Content = forwardRef<HTMLDivElement, CollapsibleContentProps>((props, ref) => {
