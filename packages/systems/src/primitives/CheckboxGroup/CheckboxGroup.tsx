...
const Root = forwardRef<HTMLDivElement, CheckboxGroupRootProps>((props, ref) => {
  const {
  ...
  return (
    <CheckboxGroupContext.Provider value={{ value, onValueChange: handleValueChange, disabled, name, orientation }}>
      <div
        ref={ref}
        role="group"
...
export interface CheckboxGroupLabelProps extends HTMLAttributes<HTMLDivElement> {
  children: ReactNode;
}

const Label = forwardRef<HTMLDivElement, CheckboxGroupLabelProps>((props, ref) => {
...
const Item = forwardRef<HTMLInputElement, CheckboxGroupItemProps>((props, ref) => {
...
export interface CheckboxGroupItemLabelProps extends LabelHTMLAttributes<HTMLLabelElement> {
  children: ReactNode;
}

const ItemLabel = forwardRef<HTMLLabelElement, CheckboxGroupItemLabelProps>((props, ref) => {
  const { children, className, ...rest } = props;
