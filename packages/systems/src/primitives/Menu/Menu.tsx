...
function Root(props: MenuRootProps) {
  ...
  const registerItem = useCallback((ref: React.RefObject<HTMLElement | null>) => {
    setItems((prev) => [...prev, ref]);
  }, []);

  const unregisterItem = useCallback((ref: React.RefObject<HTMLElement | null>) => {
...
const MenuSeparator = forwardRef<HTMLDivElement, MenuSeparatorProps>((props, ref) => {
