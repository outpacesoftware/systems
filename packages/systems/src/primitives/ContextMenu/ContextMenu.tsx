...
function Root(props: ContextMenuRootProps) {
  ...
  return (
    <ContextMenuContext.Provider value={{ open, onOpenChange: handleOpenChange, position }}>
      {children}
...
const Trigger = forwardRef<HTMLSpanElement, ContextMenuTriggerProps>((props, ref) => {
...
const Content = forwardRef<HTMLDivElement, ContextMenuContentProps>((props, ref) => {
...
const Separator = forwardRef<HTMLDivElement, ContextMenuSeparatorProps>((props, ref) => {
...
const Label = forwardRef<HTMLDivElement, ContextMenuLabelProps>((props, ref) => {
