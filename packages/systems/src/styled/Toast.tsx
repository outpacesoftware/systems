			...
			>
				<div className="relative z-10 flex gap-3">
					...
					<div className="flex-1 min-w-0">
						<p className="text-[13px] leading-4 font-medium text-white/88 tracking-[0.12px]">
							{title}
						</p>
						{description && (
							<p className="mt-1 text-[10px] leading-[13px] text-white/48 tracking-[0.12px]">
								{description}
							</p>
						)}
						{action && (
